...
new_footer = '''  <footer class="footer" id="footer" role="contentinfo">
    <div class="container">
      <div class="footer-inner" style="grid-template-columns: 1.5fr 1fr 1.5fr;">
...
for file in html_files:
    ...
    # 1. Strip section labels exactly without over-matching
    content = re.sub(r'<p class="section-label">.*?</p>', '', content, flags=re.DOTALL)
    
    # 2. Make sure navbar DOES NOT contain about
    about_link_pattern = r'\s*<li role="none"><a href="about\.html".*?</li>'
...
# Update main.js to use localStorage
main_js_path = "js/main.js"
if os.path.exists(main_js_path):
    with open(main_js_path, "r", encoding="utf-8") as f:
        main_js = f.read()
    
    main_js = main_js.replace('sessionStorage.getItem', 'localStorage.getItem')
    main_js = main_js.replace('sessionStorage.setItem', 'localStorage.setItem')
